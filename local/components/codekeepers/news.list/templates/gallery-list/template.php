		...
		<div class="owl-gallery owl-carousel owl-theme gallery-slider">
			<?foreach($arResult["ITEMS"] as $arItem):?>
                ...
                <div class="case-item" 
                    ...
                    <img class="gallery-item-img" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="01 Case Study" loading="lazy">
				</div>
			<?endforeach;?>
		</div>
	</div>
			...
			<?if($arParams["SHOW_MODE"] == 'one' || !$arParams["SHOW_MODE"]):?>
				<?foreach($arResult["ITEMS"] as $arItem):?>
					...
					<a data-fancybox="gallery" data-src="<?=$arItem["DETAIL_PICTURE"]["SRC"]?>" data-caption="<?=$arItem["NAME"]?>" class="gallery-gridify-item">
						<img id="<?=$this->GetEditAreaId($arItem['ID']);?>" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="image" loading="lazy">
					</a>
				<?endforeach;?>
				...
				<?foreach($arResult["ITEMS"] as $arItem):?>
					...
					<div class="col-md-6 col-lg-4 mb20">
						<div class="case-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>" data-fancybox="gallery" data-src="<?=$arItem["DETAIL_PICTURE"]["SRC"]?>" data-caption="<?=$arItem["NAME"]?>">
							<img class="img-fluid gallery-item-img" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="01 Case Study" loading="lazy">
